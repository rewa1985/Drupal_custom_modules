...
namespace Drupal\user_custom\Plugin\Field\FieldFormatter;
...
//use Drupal\user_custom\SlugifyText;
...
class SlugifyFormatter extends FormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      $slugify_text = \Drupal::service('user_custom.slugifytext')->slugifyText($item->value, $this->getSetting('text_separator'));
